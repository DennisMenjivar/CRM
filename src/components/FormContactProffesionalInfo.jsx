...
const FormContactProffesionalInfo = (isHidden) => {

    console.log('isHidden', isHidden.children)
    ...
    return (
        <div className="bg-white mt-10 px-5 py-10 rounded-md shadow-md md:w-3/4 mx-auto" hidden={isHidden.children}>
...
export default FormContactProffesionalInfo;
