  ...
  return loading ? (
    ...
    <>
      ...
      <div
        ...
        className="absolute mt-10 bg-red-500 p-3 text-white uppercase font-bold text-lg rounded-md"
          ...
          {({ errors, touched }) => {
            return (
              <Form className="mt-5">
                ...
                {/* BIRTHDAY */}
                <div className="mb-4">
                  <label className="text-gray-800" htmlFor="birthday">
                    Birthday:{' '}
                  </label>
                  <Field
                    name="birthday"
                ...
                {/* MARRIED */}
                <div className="mb-4">
                  <label className="text-gray-800" htmlFor="married">
                    Married:{' '}
                  </label>
                  <Field
                    name="married"
                ...
                {/* IDENTIFIER */}
                <div className="mb-4">
                  <label className="text-gray-800" htmlFor="identifier">
                    ID:{' '}
                  </label>
                  <Field
                    name="identifier"
                ...
                {/* SOCIAL */}
                <div className="mb-4">
                  <label className="text-gray-800" htmlFor="social">
                    Social Security:{' '}
                  </label>
                  <Field
                    name="social"
